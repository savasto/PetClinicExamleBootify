...
import io.bootify.pet_clinic.owner.OwnerRepository;
import io.bootify.pet_clinic.type.Type;
import io.bootify.pet_clinic.type.TypeRepository;
import io.bootify.pet_clinic.util.NotFoundException;
import io.bootify.pet_clinic.util.ReferencedWarning;
import io.bootify.pet_clinic.visit.Visit;
import io.bootify.pet_clinic.visit.VisitRepository;
...
public class PetService {
    ...
    public PetService(final PetRepository petRepository, final OwnerRepository ownerRepository,
            final TypeRepository typeRepository, final VisitRepository visitRepository) {
